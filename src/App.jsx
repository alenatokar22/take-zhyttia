      ...
      {status === "error" && (
        <main className="container">
          <div className="section">
            ...
            <div className="hint">
              Перевір, чи існує файл <code>public/data/recipes.json</code> та чи
              це валідний JSON.
            </div>
          </div>
        </main>
      ...
      {status === "ready" && recipes.length === 0 && (
        <main className="container">
          <div className="section">
            ...
            <div className="hint">
              Додай перший рецепт у <code>public/data/recipes.json</code> — і
              він з’явиться на сайті.
            </div>
          </div>
        </main>
      )}
        ...
        <main className="container">
          <section className="section">
            <div className="section-head">
              <h2>Рецепти</h2>
              <div className="hint">
                Поки рецептів мало — це нормально. Додавай по одному, і сайт
                буде рости разом з каналом 🙂
              </div>
            </div>
          ...
          <footer className="footer">
            <div className="footer-row">
              ...
              <a href={channel.youtubeUrl} target="_blank" rel="noreferrer">
                YouTube канал
              </a>
              <span className="dot">•</span>
              <span>Дані: JSON</span>
